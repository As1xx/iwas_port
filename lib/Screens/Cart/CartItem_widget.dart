    ...
    return Dismissible(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: ListTile(
            title: Text(widget.cartItem.manufacturer + ' ' + widget.cartItem.type,
                style: Theme.of(context).textTheme.caption),
            subtitle: Text('Total: ${widget.cartItem.price * widget.cartItem.quantity}',
            ...
            trailing: MyCounter(
              ...
              maxValue: widget.cartItem.maxStockQuantity.toDouble(),
